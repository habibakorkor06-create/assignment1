...
Hero: Habiba Korkor the Mage
Student ID: 16008701
GitHub account: habibakorkor06-create

A **Griffin** bars the way near **the Sinai dunes**. It only falls to
the exact blow.
...
1. Your hero name
2. Your student ID
3. Your power — your student ID **multiplied by 6**
4. Your warcry — copy the line below exactly, including punctuation:

   "By the Sinai dunes, the Griffin crumbles!"
